...
namespace Upsilon.Common.Library.UnitTests
{
    ...
    public class YConfigurationProvider_UnitTests
    {
        ...
        public void Test_01_YConfigurationProvider_FileNotExist_WithoutKey()
        {
            ...
            configurationProvider.SetConfiguration(_configTest1.config2, now.SerializeObject());
        ...
        public void Test_04_YConfigurationProvider_UsingDifferentEnum()
        {
            ...
            string config0 = configurationProvider2.GetConfiguration(_configTest2.config0);
            string config1 = configurationProvider2.GetConfiguration(_configTest2.config1);
