...
{
    [TestClass]
    public class YAssembly_UnitTests : YUnitTestsClass
    {
        [Ignore]
        [TestMethod]
        public void Test_01_YAssembly_DownloadAssembly_OK()
        {
            ...
            var deployedAssemblies = YUpdateCenter.CheckForUpdate("http://api.upsilon-ecosystem.xyz/deployed.assemblies.json", "Upsilon.Tools.ReleaseManagementTool.Core", out var assembly);
